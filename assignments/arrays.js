...
for (let i = 0; i < inventory.length; i++) {
    if (inventory[i].id === 33){
        filteredArray.push(inventory[i])
    }
}


//const {car_year, car_make, car_model} = filteredArray[0]

console.log(`Car 33 is a ${filteredArray[0].car_year}, ${filteredArray[0].car_make}, ${filteredArray[0].car_model}`);
...
let lastCar = [];
for (let i = 0; i < inventory.length; i++) {
    if (inventory[i].id === 49){
        lastCar.push(inventory[i])
    }
}

console.log(lastCar[0].car_make, lastCar[0].car_model);
